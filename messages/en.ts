...
const en: Translations = {
  ...
  history: {
    ...
    emptyAction: "Create your first document",
  ...
  refinement: {
    ...
    fixEnglish: "Fix English",
    moreFormalTitle: "Rewrite in a more formal, professional academic register",
    expandTitle: "Expand with ~25% more specific detail",
    shortenTitle: "Condense by ~25% without losing key points",
    addKeywordsTitle: "Naturally integrate programme/role-relevant keywords",
    cultureCheckTitle: "Analyse cultural fit: directness, evidence, framing",
    fixEnglishTitle: "Fix grammar, articles, prepositions, and ESL errors",
    stop: "stop",
    cultureCheckHeading: "Culture Check",
    closeFeedback: "Close",
  },
  feedbackPanel: {
    heading: "Document analysis",
    commentCount: "{count} insights",
    noComments: "No insights available.",
    filterAll: "All",
    filterStrength: "Strengths",
    ...
    typeNote: "Note",
    applying: "Applying…",
    applyAction: "Apply this suggestion →",
    overallQuality: "Overall quality",
    improveHint: "Apply {count} suggestions to reach {target}/10",
  },
  errors: {
